...
if sys.argv[1] == "getversion":
    ...
    json_data['linksnapshot'] = "https://github.com/ohAnd/LEDdimmerMQTT/releases/download/snapshot/LEDdimmerMQTT_snapshot_" + version_string_new + ".bin"
    json_data['link'] = "https://github.com/ohAnd/LEDdimmerMQTT/releases/latest/download/LEDdimmerMQTT_release_" + version_string_new + ".bin"
